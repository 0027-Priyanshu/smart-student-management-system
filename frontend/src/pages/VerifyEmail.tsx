  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 relative px-4 overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-md p-6 sm:p-8 bg-white/40 border border-slate-200 rounded-3xl backdrop-blur-md shadow-card text-center space-y-6 z-10"
      >
        {status === 'loading' && (
        ...
        {status === 'error' && (
          <div className="flex flex-col items-center space-y-4">
            ...
            <button
              ...
              className="mt-4 px-5 py-2.5 text-xs font-semibold bg-slate-100 hover:bg-slate-500 text-slate-900 rounded-xl border border-slate-300 transition-colors"
            >
              Back to Login
            </button>
          </div>
