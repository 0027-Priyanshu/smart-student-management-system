  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0b0c10] text-gray-200 relative px-4 overflow-hidden">
      ...
      <div className="text-center space-y-6 max-w-md z-10">
        ...
        <h1 className="text-8xl font-black tracking-tight text-white select-none">500</h1>
        ...
        <div className="space-y-2">
          ...
          {error?.message && (
            <pre className="p-3 bg-white/2 rounded-xl text-[10px] font-mono text-left text-red-400 border border-white/5 max-h-32 overflow-y-auto mt-2">
              {error.message}
            </pre>
          )}
        </div>
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-6 py-3 text-xs font-semibold bg-red-500 hover:bg-red-600 text-white rounded-xl shadow-lg transition-all"
        >
