...
const CourseSchema = new mongoose_1.Schema({
    ...
    facultyId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Faculty' }, // Reference to Faculty member
    enrolledStudents: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Student' }], // Enrolled Students
