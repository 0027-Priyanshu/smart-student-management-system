  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 text-gray-200 relative px-4 overflow-hidden">
      ...
      <div className="text-center space-y-6 max-w-md z-10">
        ...
        <button
          onClick={() => navigate(-1)}
          className="inline-flex items-center justify-center gap-2 px-6 py-3 text-xs font-semibold bg-[#8a5cf6] hover:bg-[#7c4df2] text-slate-900 rounded-xl shadow-lg transition-all"
        >
          <ArrowLeft size={16} />
          Go Back
        </button>
